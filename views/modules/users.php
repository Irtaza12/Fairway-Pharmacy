                ...
                echo '
                  ...
                  <tr>
                    ...
                    if ($value["photo"] != ""){
                      ...
                      echo '<td><img src="views/img/users/default/abx.png" class="img-thumbnail" width="40px"></td>';
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="newProfile">
                  ...
                  <option value="special">End User</option>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <img class="thumbnail preview" src="views/img/users/default/abx.png" alt="" width="100px">
